...
var file_msg_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x65, 0x72, 0x41, 0x66, 0x74, 0x65, 0x72, 0x32, 0xae, 0x02, 0x0a, 0x0a, 0x6d, 0x73,
	0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x11, 0x49, 0x6e, 0x73, 0x65,
	0x72, 0x74, 0x4d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x0f, 0x2e,
	0x70, 0x62, 0x2e, 0x4d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x1a, 0x0e,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f,
...
var file_msg_proto_goTypes = []interface{}{
	...
	(*MsgData_Options)(nil),     // 7: pb.MsgData.Options
	(*MsgData_Receiver)(nil),    // 8: pb.MsgData.Receiver
	(ContentType)(0),            // 9: pb.ContentType
	(*Requester)(nil),           // 10: pb.Requester
	(*CommonResp)(nil),          // 11: pb.CommonResp
}
var file_msg_proto_depIdxs = []int32{
	0,  // 0: pb.MsgMQBody.event:type_name -> pb.MsgMQBody.Event
	8,  // 1: pb.MsgData.receiver:type_name -> pb.MsgData.Receiver
	9,  // 2: pb.MsgData.contentType:type_name -> pb.ContentType
	7,  // 3: pb.MsgData.options:type_name -> pb.MsgData.Options
	6,  // 4: pb.MsgData.offlinePush:type_name -> pb.MsgData.OfflinePush
	2,  // 5: pb.MsgDataList.msgDataList:type_name -> pb.MsgData
	10, // 6: pb.SendMsgListReq.requester:type_name -> pb.Requester
	2,  // 7: pb.SendMsgListReq.msgDataList:type_name -> pb.MsgData
	10, // 8: pb.BatchSendMsgReq.requester:type_name -> pb.Requester
	...
	5,  // 13: pb.msgService.BatchSendMsgSync:input_type -> pb.BatchSendMsgReq
	5,  // 14: pb.msgService.BatchSendMsgAsync:input_type -> pb.BatchSendMsgReq
	11, // 15: pb.msgService.InsertMsgDataList:output_type -> pb.CommonResp
	11, // 16: pb.msgService.SendMsgListSync:output_type -> pb.CommonResp
	11, // 17: pb.msgService.SendMsgListAsync:output_type -> pb.CommonResp
	11, // 18: pb.msgService.BatchSendMsgSync:output_type -> pb.CommonResp
	11, // 19: pb.msgService.BatchSendMsgAsync:output_type -> pb.CommonResp
