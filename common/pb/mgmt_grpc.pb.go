...
func (c *mgmtServiceClient) LoginMSCaptcha(ctx context.Context, in *LoginMSCaptchaReq, opts ...grpc.CallOption) (*LoginMSCaptchaResp, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.mgmtService/LoginMSCaptcha", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mgmtServiceClient) VerifyLoginMSCaptchaCode(ctx context.Context, in *VerifyLoginMSCaptchaCodeReq, opts ...grpc.CallOption) (*VerifyLoginMSCaptchaCodeResp, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.mgmtService/VerifyLoginMSCaptchaCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mgmtServiceClient) ClearAllUser(ctx context.Context, in *ClearAllUserReq, opts ...grpc.CallOption) (*ClearAllUserResp, error) {
	out := new(ClearAllUserResp)
	err := c.cc.Invoke(ctx, "/pb.mgmtService/ClearAllUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MgmtServiceServer interface {
	...
	//清空所有用户
	ClearAllUser(context.Context, *ClearAllUserReq) (*ClearAllUserResp, error)
...
func (UnimplementedMgmtServiceServer) ClearAllUser(context.Context, *ClearAllUserReq) (*ClearAllUserResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ClearAllUser not implemented")
}
...
func _MgmtService_LoginMSCaptcha_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.mgmtService/LoginMSCaptcha",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MgmtService_VerifyLoginMSCaptchaCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.mgmtService/VerifyLoginMSCaptchaCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MgmtService_ClearAllUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearAllUserReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MgmtServiceServer).ClearAllUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.mgmtService/ClearAllUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MgmtServiceServer).ClearAllUser(ctx, req.(*ClearAllUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MgmtService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ClearAllUser",
			Handler:    _MgmtService_ClearAllUser_Handler,
		},
	},
