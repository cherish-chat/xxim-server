...
var file_gateway_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x73, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32,
	0x9b, 0x03, 0x0a, 0x0e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x65, 0x44, 0x61, 0x74, 0x61, 0x54, 0x6f, 0x57, 0x73, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06, 0x5a,
...
var file_gateway_proto_depIdxs = []int32{
	12, // 0: pb.GatewayApiRequest.header:type_name -> pb.RequestHeader
	13, // 1: pb.GatewayApiResponse.header:type_name -> pb.ResponseHeader
	12, // 2: pb.WsConnection.header:type_name -> pb.RequestHeader
	12, // 3: pb.GatewayGetUserConnectionReq.header:type_name -> pb.RequestHeader
	13, // 4: pb.GatewayGetUserConnectionResp.header:type_name -> pb.ResponseHeader
	2,  // 5: pb.GatewayGetUserConnectionResp.connections:type_name -> pb.WsConnection
	12, // 6: pb.GatewayBatchGetUserConnectionReq.header:type_name -> pb.RequestHeader
	13, // 7: pb.GatewayBatchGetUserConnectionResp.header:type_name -> pb.ResponseHeader
	2,  // 8: pb.GatewayBatchGetUserConnectionResp.connections:type_name -> pb.WsConnection
	12, // 9: pb.GatewayGetConnectionByFilterReq.header:type_name -> pb.RequestHeader
	7,  // 10: pb.GatewayGetConnectionByFilterReq.filter:type_name -> pb.GatewayGetConnectionFilter
	13, // 11: pb.GatewayGetConnectionByFilterResp.header:type_name -> pb.ResponseHeader
	2,  // 12: pb.GatewayGetConnectionByFilterResp.connections:type_name -> pb.WsConnection
	12, // 13: pb.GatewayWriteDataToWsReq.header:type_name -> pb.RequestHeader
	7,  // 14: pb.GatewayWriteDataToWsReq.filter:type_name -> pb.GatewayGetConnectionFilter
	13, // 15: pb.GatewayWriteDataToWsResp.header:type_name -> pb.ResponseHeader
	2,  // 16: pb.GatewayWriteDataToWsResp.successConnections:type_name -> pb.WsConnection
	3,  // 17: pb.gatewayService.GatewayGetUserConnection:input_type -> pb.GatewayGetUserConnectionReq
	5,  // 18: pb.gatewayService.GatewayBatchGetUserConnection:input_type -> pb.GatewayBatchGetUserConnectionReq
	8,  // 19: pb.gatewayService.GatewayGetConnectionByFilter:input_type -> pb.GatewayGetConnectionByFilterReq
	10, // 20: pb.gatewayService.GatewayWriteDataToWs:input_type -> pb.GatewayWriteDataToWsReq
	4,  // 21: pb.gatewayService.GatewayGetUserConnection:output_type -> pb.GatewayGetUserConnectionResp
	6,  // 22: pb.gatewayService.GatewayBatchGetUserConnection:output_type -> pb.GatewayBatchGetUserConnectionResp
	9,  // 23: pb.gatewayService.GatewayGetConnectionByFilter:output_type -> pb.GatewayGetConnectionByFilterResp
	11, // 24: pb.gatewayService.GatewayWriteDataToWs:output_type -> pb.GatewayWriteDataToWsResp
