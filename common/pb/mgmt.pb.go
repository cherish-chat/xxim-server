...
type GetServerConfigReq struct {
	...
	ServerName string `protobuf:"bytes,1,opt,name=serverName,proto3" json:"serverName"`
}
...
type GetServerConfigResp struct {
	...
	Config []byte `protobuf:"bytes,1,opt,name=config,proto3" json:"config"`
}
...
var file_mgmt_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x34, 0x0a, 0x12, 0x47, 0x65,
	...
	0x22, 0x2d, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x32,
	0xc1, 0x01, 0x0a, 0x0b, 0x6d, 0x67, 0x6d, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x42, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x12, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x71, 0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e,
...
var file_mgmt_proto_goTypes = []interface{}{
	...
	(*AfterConnectReq)(nil),     // 2: pb.AfterConnectReq
	(*AfterDisconnectReq)(nil),  // 3: pb.AfterDisconnectReq
	(*CommonResp)(nil),          // 4: pb.CommonResp
}
var file_mgmt_proto_depIdxs = []int32{
	2, // 0: pb.mgmtService.AfterConnect:input_type -> pb.AfterConnectReq
	3, // 1: pb.mgmtService.AfterDisconnect:input_type -> pb.AfterDisconnectReq
	0, // 2: pb.mgmtService.GetServerConfig:input_type -> pb.GetServerConfigReq
	4, // 3: pb.mgmtService.AfterConnect:output_type -> pb.CommonResp
	4, // 4: pb.mgmtService.AfterDisconnect:output_type -> pb.CommonResp
	1, // 5: pb.mgmtService.GetServerConfig:output_type -> pb.GetServerConfigResp
