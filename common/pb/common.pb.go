...
type RequestHeader struct {
	...
	RequestId    string        `protobuf:"bytes,1,opt,name=requestId,proto3" json:"requestId"`                       // 请求id
	AppId        string        `protobuf:"bytes,2,opt,name=appId,proto3" json:"appId"`                               // 应用id
	UserId       string        `protobuf:"bytes,3,opt,name=userId,proto3" json:"userId"`                             // 用户id
	UserToken    string        `protobuf:"bytes,4,opt,name=userToken,proto3" json:"userToken"`                       // token
	ClientIp     string        `protobuf:"bytes,5,opt,name=clientIp,proto3" json:"clientIp"`                         // 客户端ip
	InstallId    string        `protobuf:"bytes,6,opt,name=installId,proto3" json:"installId"`                       // 安装后向服务器注册的UUID
	Platform     Platform      `protobuf:"varint,7,opt,name=platform,proto3,enum=pb.Platform" json:"platform"`       // 平台
	GatewayPodIp string        `protobuf:"bytes,8,opt,name=gatewayPodIp,proto3" json:"gatewayPodIp"`                 // 网关pod的ip
	DeviceModel  string        `protobuf:"bytes,9,opt,name=deviceModel,proto3" json:"deviceModel"`                   // 设备型号
	OsVersion    string        `protobuf:"bytes,10,opt,name=osVersion,proto3" json:"osVersion"`                      // 操作系统版本
	AppVersion   string        `protobuf:"bytes,11,opt,name=appVersion,proto3" json:"appVersion"`                    // app版本
	Language     I18NLanguage  `protobuf:"varint,12,opt,name=language,proto3,enum=pb.I18NLanguage" json:"language"`  // 语言
	ConnectTime  int64         `protobuf:"varint,13,opt,name=connectTime,proto3" json:"connectTime"`                 // 连接时间 13位时间戳
	AesKey       string        `protobuf:"bytes,21,opt,name=aesKey,proto3" json:"aesKey"`                            // 32位 aes加密的key
	AesIv        string        `protobuf:"bytes,22,opt,name=aesIv,proto3" json:"aesIv"`                              // 16位 aes加密的iv
	Encoding     EncodingProto `protobuf:"varint,23,opt,name=encoding,proto3,enum=pb.EncodingProto" json:"encoding"` // 编码
}
...
func (x *RequestHeader) GetAesKey() string {
	if x != nil {
		return x.AesKey
	}
	return ""
...
func (x *RequestHeader) GetAesIv() string {
	if x != nil {
		return x.AesIv
	}
	return ""
...
var file_common_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x22, 0x8e, 0x04, 0x0a, 0x0d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49,
	...
	,
	...
	,
	...
	,
	...
	0x62, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x04,
	0x63, 0x6f, 0x64, 0x65, 0x12, 0x36, 0x0a, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1e, 0x0a, 0x0a,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x2a, 0x64, 0x0a, 0x08,
	...
	0x5f, 0x41, 0x55, 0x54, 0x48, 0x5f, 0x41, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x03, 0x42, 0x06,
...
var file_common_proto_goTypes = []interface{}{
	...
	(ToastActionData_Level)(0),      // 5: pb.ToastActionData.Level
	(AlertActionData_ButtonType)(0), // 6: pb.AlertActionData.ButtonType
	(*RequestHeader)(nil),           // 7: pb.RequestHeader
	(*ToastActionData)(nil),         // 8: pb.ToastActionData
	(*AlertActionData)(nil),         // 9: pb.AlertActionData
...
var file_common_proto_depIdxs = []int32{
	...
	5, // 3: pb.ToastActionData.level:type_name -> pb.ToastActionData.Level
	6, // 4: pb.AlertActionData.buttonType:type_name -> pb.AlertActionData.ButtonType
