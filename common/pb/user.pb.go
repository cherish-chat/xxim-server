...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x2a, 0x29, 0x0a, 0x02, 0x58, 0x42, 0x12, 0x0d, 0x0a, 0x09,
	...
	0x10, 0x0c, 0x32, 0xc7, 0x02, 0x0a, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x65, 0x72, 0x48, 0x6f, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x06, 0x5a, 0x04,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*BirthdayInfo)(nil),             // 2: pb.BirthdayInfo
	(*LevelInfo)(nil),                // 3: pb.LevelInfo
	(*UserBaseInfo)(nil),             // 4: pb.UserBaseInfo
	(*LoginReq)(nil),                 // 5: pb.LoginReq
	(*LoginResp)(nil),                // 6: pb.LoginResp
	(*ConfirmRegisterReq)(nil),       // 7: pb.ConfirmRegisterReq
	(*ConfirmRegisterResp)(nil),      // 8: pb.ConfirmRegisterResp
	(*MapUserByIdsReq)(nil),          // 9: pb.MapUserByIdsReq
	(*MapUserByIdsResp)(nil),         // 10: pb.MapUserByIdsResp
	(*SearchUsersByKeywordReq)(nil),  // 11: pb.SearchUsersByKeywordReq
	(*SearchUsersByKeywordResp)(nil), // 12: pb.SearchUsersByKeywordResp
	(*GetUserHomeReq)(nil),           // 13: pb.GetUserHomeReq
	(*GetUserHomeResp)(nil),          // 14: pb.GetUserHomeResp
	nil,                              // 15: pb.MapUserByIdsResp.UsersEntry
	(*IpRegion)(nil),                 // 16: pb.IpRegion
	(*Requester)(nil),                // 17: pb.Requester
...
var file_user_proto_depIdxs = []int32{
	...
	2,  // 2: pb.UserBaseInfo.birthday:type_name -> pb.BirthdayInfo
	16, // 3: pb.UserBaseInfo.ipRegion:type_name -> pb.IpRegion
	17, // 4: pb.LoginReq.requester:type_name -> pb.Requester
	18, // 5: pb.LoginResp.commonResp:type_name -> pb.CommonResp
	17, // 6: pb.ConfirmRegisterReq.requester:type_name -> pb.Requester
	18, // 7: pb.ConfirmRegisterResp.commonResp:type_name -> pb.CommonResp
	17, // 8: pb.MapUserByIdsReq.requester:type_name -> pb.Requester
	18, // 9: pb.MapUserByIdsResp.commonResp:type_name -> pb.CommonResp
	15, // 10: pb.MapUserByIdsResp.users:type_name -> pb.MapUserByIdsResp.UsersEntry
	17, // 11: pb.SearchUsersByKeywordReq.requester:type_name -> pb.Requester
	18, // 12: pb.SearchUsersByKeywordResp.commonResp:type_name -> pb.CommonResp
	4,  // 13: pb.SearchUsersByKeywordResp.users:type_name -> pb.UserBaseInfo
	17, // 14: pb.GetUserHomeReq.requester:type_name -> pb.Requester
	18, // 15: pb.GetUserHomeResp.commonResp:type_name -> pb.CommonResp
	0,  // 16: pb.GetUserHomeResp.xb:type_name -> pb.XB
	2,  // 17: pb.GetUserHomeResp.birthday:type_name -> pb.BirthdayInfo
	16, // 18: pb.GetUserHomeResp.ipRegion:type_name -> pb.IpRegion
	3,  // 19: pb.GetUserHomeResp.levelInfo:type_name -> pb.LevelInfo
	5,  // 20: pb.userService.Login:input_type -> pb.LoginReq
	7,  // 21: pb.userService.ConfirmRegister:input_type -> pb.ConfirmRegisterReq
	9,  // 22: pb.userService.MapUserByIds:input_type -> pb.MapUserByIdsReq
	11, // 23: pb.userService.SearchUsersByKeyword:input_type -> pb.SearchUsersByKeywordReq
	13, // 24: pb.userService.GetUserHome:input_type -> pb.GetUserHomeReq
	6,  // 25: pb.userService.Login:output_type -> pb.LoginResp
	8,  // 26: pb.userService.ConfirmRegister:output_type -> pb.ConfirmRegisterResp
	10, // 27: pb.userService.MapUserByIds:output_type -> pb.MapUserByIdsResp
	12, // 28: pb.userService.SearchUsersByKeyword:output_type -> pb.SearchUsersByKeywordResp
	14, // 29: pb.userService.GetUserHome:output_type -> pb.GetUserHomeResp
