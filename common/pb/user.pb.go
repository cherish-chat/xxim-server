...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x2a, 0x29, 0x0a, 0x02, 0x58, 0x42, 0x12, 0x0d, 0x0a, 0x09, 0x55, 0x6e, 0x6b, 0x6e, 0x6f,
	...
	0x65, 0x10, 0x15, 0x32, 0xf3, 0x05, 0x0a, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70,
...
var file_user_proto_goTypes = []interface{}{
	...
	nil,                                           // 25: pb.MapUserByIdsResp.UsersEntry
	nil,                                           // 26: pb.GetUserSettingsResp.SettingsEntry
	(*BatchGetUserAllDevicesResp_AllDevices)(nil), // 27: pb.BatchGetUserAllDevicesResp.AllDevices
	(*IpRegion)(nil),                              // 28: pb.IpRegion
	(*CommonReq)(nil),                             // 29: pb.CommonReq
	(*CommonResp)(nil),                            // 30: pb.CommonResp
	(*AfterConnectReq)(nil),                       // 31: pb.AfterConnectReq
	(*AfterDisconnectReq)(nil),                    // 32: pb.AfterDisconnectReq
}
var file_user_proto_depIdxs = []int32{
	...
	28, // 3: pb.UserBaseInfo.ipRegion:type_name -> pb.IpRegion
	29, // 4: pb.LoginReq.commonReq:type_name -> pb.CommonReq
	30, // 5: pb.LoginResp.commonResp:type_name -> pb.CommonResp
	29, // 6: pb.ConfirmRegisterReq.commonReq:type_name -> pb.CommonReq
	30, // 7: pb.ConfirmRegisterResp.commonResp:type_name -> pb.CommonResp
	29, // 8: pb.MapUserByIdsReq.commonReq:type_name -> pb.CommonReq
	30, // 9: pb.MapUserByIdsResp.commonResp:type_name -> pb.CommonResp
	25, // 10: pb.MapUserByIdsResp.users:type_name -> pb.MapUserByIdsResp.UsersEntry
	29, // 11: pb.BatchGetUserBaseInfoReq.commonReq:type_name -> pb.CommonReq
	30, // 12: pb.BatchGetUserBaseInfoResp.commonResp:type_name -> pb.CommonResp
	5,  // 13: pb.BatchGetUserBaseInfoResp.userBaseInfos:type_name -> pb.UserBaseInfo
	29, // 14: pb.SearchUsersByKeywordReq.commonReq:type_name -> pb.CommonReq
	30, // 15: pb.SearchUsersByKeywordResp.commonResp:type_name -> pb.CommonResp
	5,  // 16: pb.SearchUsersByKeywordResp.users:type_name -> pb.UserBaseInfo
	29, // 17: pb.GetUserHomeReq.commonReq:type_name -> pb.CommonReq
	30, // 18: pb.GetUserHomeResp.commonResp:type_name -> pb.CommonResp
	0,  // 19: pb.GetUserHomeResp.xb:type_name -> pb.XB
	3,  // 20: pb.GetUserHomeResp.birthday:type_name -> pb.BirthdayInfo
	28, // 21: pb.GetUserHomeResp.ipRegion:type_name -> pb.IpRegion
	4,  // 22: pb.GetUserHomeResp.levelInfo:type_name -> pb.LevelInfo
	29, // 23: pb.GetUserSettingsReq.commonReq:type_name -> pb.CommonReq
	2,  // 24: pb.GetUserSettingsReq.keys:type_name -> pb.UserSettingKey
	2,  // 25: pb.UserSetting.key:type_name -> pb.UserSettingKey
	30, // 26: pb.GetUserSettingsResp.commonResp:type_name -> pb.CommonResp
	26, // 27: pb.GetUserSettingsResp.settings:type_name -> pb.GetUserSettingsResp.SettingsEntry
	29, // 28: pb.SetUserSettingsReq.commonReq:type_name -> pb.CommonReq
	19, // 29: pb.SetUserSettingsReq.settings:type_name -> pb.UserSetting
	30, // 30: pb.SetUserSettingsResp.commonResp:type_name -> pb.CommonResp
	29, // 31: pb.BatchGetUserAllDevicesReq.commonReq:type_name -> pb.CommonReq
	30, // 32: pb.BatchGetUserAllDevicesResp.commonResp:type_name -> pb.CommonResp
	27, // 33: pb.BatchGetUserAllDevicesResp.allDevices:type_name -> pb.BatchGetUserAllDevicesResp.AllDevices
	19, // 34: pb.GetUserSettingsResp.SettingsEntry.value:type_name -> pb.UserSetting
	6,  // 35: pb.userService.Login:input_type -> pb.LoginReq
	8,  // 36: pb.userService.ConfirmRegister:input_type -> pb.ConfirmRegisterReq
	10, // 37: pb.userService.MapUserByIds:input_type -> pb.MapUserByIdsReq
	12, // 38: pb.userService.BatchGetUserBaseInfo:input_type -> pb.BatchGetUserBaseInfoReq
	14, // 39: pb.userService.SearchUsersByKeyword:input_type -> pb.SearchUsersByKeywordReq
	16, // 40: pb.userService.GetUserHome:input_type -> pb.GetUserHomeReq
	18, // 41: pb.userService.GetUserSettings:input_type -> pb.GetUserSettingsReq
	21, // 42: pb.userService.SetUserSettings:input_type -> pb.SetUserSettingsReq
	31, // 43: pb.userService.AfterConnect:input_type -> pb.AfterConnectReq
	32, // 44: pb.userService.AfterDisconnect:input_type -> pb.AfterDisconnectReq
	23, // 45: pb.userService.BatchGetUserAllDevices:input_type -> pb.BatchGetUserAllDevicesReq
	7,  // 46: pb.userService.Login:output_type -> pb.LoginResp
	9,  // 47: pb.userService.ConfirmRegister:output_type -> pb.ConfirmRegisterResp
	11, // 48: pb.userService.MapUserByIds:output_type -> pb.MapUserByIdsResp
	13, // 49: pb.userService.BatchGetUserBaseInfo:output_type -> pb.BatchGetUserBaseInfoResp
	15, // 50: pb.userService.SearchUsersByKeyword:output_type -> pb.SearchUsersByKeywordResp
	17, // 51: pb.userService.GetUserHome:output_type -> pb.GetUserHomeResp
	20, // 52: pb.userService.GetUserSettings:output_type -> pb.GetUserSettingsResp
	22, // 53: pb.userService.SetUserSettings:output_type -> pb.SetUserSettingsResp
	30, // 54: pb.userService.AfterConnect:output_type -> pb.CommonResp
	30, // 55: pb.userService.AfterDisconnect:output_type -> pb.CommonResp
	24, // 56: pb.userService.BatchGetUserAllDevices:output_type -> pb.BatchGetUserAllDevicesResp
