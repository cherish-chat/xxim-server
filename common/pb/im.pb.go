...
type ConvSettingProto2 struct {
	...
	ConvId string `protobuf:"bytes,2,opt,name=convId,proto3" json:"convId"`
	// 置顶
	IsTop int32 `protobuf:"varint,3,opt,name=isTop,proto3" json:"isTop"` // 0 未设置 1 true 2 false
	// 设为免打扰
	IsDisturb int32 `protobuf:"varint,4,opt,name=isDisturb,proto3" json:"isDisturb"`
	// 消息通知设置 （当免打扰时，此设置无效）
	// 通知显示消息预览
	NotifyPreview int32 `protobuf:"varint,5,opt,name=notifyPreview,proto3" json:"notifyPreview"`
	// 通知声音
	NotifySound int32 `protobuf:"varint,6,opt,name=notifySound,proto3" json:"notifySound"`
	// 通知自定义声音
	NotifyCustomSound string `protobuf:"bytes,7,opt,name=notifyCustomSound,proto3" json:"notifyCustomSound"`
	// 通知震动
	NotifyVibrate int32 `protobuf:"varint,8,opt,name=notifyVibrate,proto3" json:"notifyVibrate"`
	// 屏蔽消息
	IsShield int32 `protobuf:"varint,9,opt,name=isShield,proto3" json:"isShield"`
	// 聊天背景
	ChatBg string `protobuf:"bytes,10,opt,name=chatBg,proto3" json:"chatBg"`
}

func (x *ConvSettingProto2) Reset() {
	*x = ConvSettingProto2{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConvSettingProto2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConvSettingProto2) ProtoMessage() {}

func (x *ConvSettingProto2) ProtoReflect() protoreflect.Message {
	mi := &file_im_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConvSettingProto2.ProtoReflect.Descriptor instead.
func (*ConvSettingProto2) Descriptor() ([]byte, []int) {
	return file_im_proto_rawDescGZIP(), []int{13}
}

func (x *ConvSettingProto2) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ConvSettingProto2) GetConvId() string {
	if x != nil {
		return x.ConvId
	}
	return ""
...
func (x *ConvSettingProto2) GetIsTop() int32 {
	if x != nil {
		return x.IsTop
	}
	return 0
...
func (x *ConvSettingProto2) GetIsDisturb() int32 {
	if x != nil {
		return x.IsDisturb
	}
	return 0
...
func (x *ConvSettingProto2) GetNotifyPreview() int32 {
	if x != nil {
		return x.NotifyPreview
	}
	return 0
...
func (x *ConvSettingProto2) GetNotifySound() int32 {
	if x != nil {
		return x.NotifySound
	}
	return 0
...
func (x *ConvSettingProto2) GetNotifyCustomSound() string {
	if x != nil {
		return x.NotifyCustomSound
	}
	return ""
...
func (x *ConvSettingProto2) GetNotifyVibrate() int32 {
	if x != nil {
		return x.NotifyVibrate
	}
	return 0
...
func (x *ConvSettingProto2) GetIsShield() int32 {
	if x != nil {
		return x.IsShield
	}
	return 0
...
func (x *ConvSettingProto2) GetChatBg() string {
	if x != nil {
		return x.ChatBg
	}
	return ""
...
type UpdateConvSettingReq struct {
	...
	ConvSetting2 *ConvSettingProto2 `protobuf:"bytes,3,opt,name=convSetting2,proto3" json:"convSetting2"`
}
...
func (x *UpdateConvSettingReq) GetConvSetting2() *ConvSettingProto2 {
	if x != nil {
		return x.ConvSetting2
	}
	return nil
}
...
type GetConvSettingResp struct {
	...
	ConvSetting2S []*ConvSettingProto2 `protobuf:"bytes,3,rep,name=convSetting2s,proto3" json:"convSetting2s"`
}
...
func (x *GetConvSettingResp) GetConvSetting2S() []*ConvSettingProto2 {
	if x != nil {
		return x.ConvSetting2S
	}
	return nil
}

// TranslateTextReq 翻译文本
type TranslateTextReq struct {
	...
	CommonReq *CommonReq `protobuf:"bytes,1,opt,name=commonReq,proto3" json:"commonReq"`
	Q         string     `protobuf:"bytes,2,opt,name=q,proto3" json:"q"`       // 不能为空
	From      string     `protobuf:"bytes,3,opt,name=from,proto3" json:"from"` // 默认是auto
	To        string     `protobuf:"bytes,4,opt,name=to,proto3" json:"to"`     // 默认是auto
}
...
func (x *TranslateTextReq) GetCommonReq() *CommonReq {
	if x != nil {
		return x.CommonReq
	}
	return nil
...
func (x *TranslateTextReq) GetQ() string {
	if x != nil {
		return x.Q
	}
	return ""
...
func (x *TranslateTextReq) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *TranslateTextReq) GetTo() string {
	if x != nil {
		return x.To
	}
	return ""
...
func (x *TranslateTextResp) GetCommonResp() *CommonResp {
	if x != nil {
		return x.CommonResp
	}
	return nil
...
func (x *TranslateTextResp) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
// BatchTranslateTextReq 翻译文本
type BatchTranslateTextReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	CommonReq *CommonReq `protobuf:"bytes,1,opt,name=commonReq,proto3" json:"commonReq"`
	Q         string     `protobuf:"bytes,2,opt,name=q,proto3" json:"q"`           // 不能为空
	From      string     `protobuf:"bytes,3,opt,name=from,proto3" json:"from"`     // 不能为空
	ToList    []string   `protobuf:"bytes,4,rep,name=toList,proto3" json:"toList"` // 不能为空
}

func (x *BatchTranslateTextReq) Reset() {
	*x = BatchTranslateTextReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchTranslateTextReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchTranslateTextReq) ProtoMessage() {}

func (x *BatchTranslateTextReq) ProtoReflect() protoreflect.Message {
	mi := &file_im_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchTranslateTextReq.ProtoReflect.Descriptor instead.
func (*BatchTranslateTextReq) Descriptor() ([]byte, []int) {
	return file_im_proto_rawDescGZIP(), []int{20}
}

func (x *BatchTranslateTextReq) GetCommonReq() *CommonReq {
	if x != nil {
		return x.CommonReq
	}
	return nil
...
func (x *BatchTranslateTextReq) GetQ() string {
	if x != nil {
		return x.Q
	}
	return ""
...
func (x *BatchTranslateTextReq) GetFrom() string {
	if x != nil {
		return x.From
	}
	return ""
...
func (x *BatchTranslateTextReq) GetToList() []string {
	if x != nil {
		return x.ToList
	}
	return nil
...
// BatchTranslateTextResp 翻译文本
type BatchTranslateTextResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CommonResp *CommonResp       `protobuf:"bytes,1,opt,name=commonResp,proto3" json:"commonResp"`
	Results    map[string]string `protobuf:"bytes,2,rep,name=results,proto3" json:"results" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *BatchTranslateTextResp) Reset() {
	*x = BatchTranslateTextResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchTranslateTextResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchTranslateTextResp) ProtoMessage() {}

func (x *BatchTranslateTextResp) ProtoReflect() protoreflect.Message {
	mi := &file_im_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchTranslateTextResp.ProtoReflect.Descriptor instead.
func (*BatchTranslateTextResp) Descriptor() ([]byte, []int) {
	return file_im_proto_rawDescGZIP(), []int{21}
}

func (x *BatchTranslateTextResp) GetCommonResp() *CommonResp {
	if x != nil {
		return x.CommonResp
	}
	return nil
...
func (x *BatchTranslateTextResp) GetResults() map[string]string {
	if x != nil {
		return x.Results
	}
	return nil
...
var file_im_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x22, 0x5a, 0x0a, 0x11, 0x47, 0x65,
	0x74, 0x43, 0x6f, 0x6e, 0x76, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x12,
	...
	0x63, 0x6f, 0x6e, 0x76, 0x49, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x63,
	0x6f, 0x6e, 0x76, 0x49, 0x64, 0x73, 0x22, 0xb6, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x43, 0x6f,
	...
	,
	...
	0x74, 0x6f, 0x22, 0x5b, 0x0a, 0x11, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x54,
	0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2e, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22,
	0x7e, 0x0a, 0x15, 0x42, 0x61, 0x74, 0x63, 0x68, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74,
	0x65, 0x54, 0x65, 0x78, 0x74, 0x52, 0x65, 0x71, 0x12, 0x2b, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xce, 0x07, 0x0a, 0x09, 0x69, 0x6d,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x0d, 0x42, 0x65, 0x66, 0x6f, 0x72,
	0x65, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x42, 0x65,
	0x66, 0x6f, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x15,
	0x2e, 0x70, 0x62, 0x2e, 0x42, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x33, 0x0a, 0x0c, 0x41, 0x66, 0x74, 0x65, 0x72, 0x43, 0x6f,
	...
	,
...
var file_im_proto_goTypes = []interface{}{
	...
	(*ConvSettingProto2)(nil),          // 14: pb.ConvSettingProto2
	(*UpdateConvSettingReq)(nil),       // 15: pb.UpdateConvSettingReq
	(*UpdateConvSettingResp)(nil),      // 16: pb.UpdateConvSettingResp
	(*GetConvSettingReq)(nil),          // 17: pb.GetConvSettingReq
	(*GetConvSettingResp)(nil),         // 18: pb.GetConvSettingResp
	(*TranslateTextReq)(nil),           // 19: pb.TranslateTextReq
	(*TranslateTextResp)(nil),          // 20: pb.TranslateTextResp
	(*BatchTranslateTextReq)(nil),      // 21: pb.BatchTranslateTextReq
	(*BatchTranslateTextResp)(nil),     // 22: pb.BatchTranslateTextResp
	nil,                                // 23: pb.BatchTranslateTextResp.ResultsEntry
	(*ConnParam)(nil),                  // 24: pb.ConnParam
	(*IpRegion)(nil),                   // 25: pb.IpRegion
	(*CommonReq)(nil),                  // 26: pb.CommonReq
	(*CommonResp)(nil),                 // 27: pb.CommonResp
	(*AfterConnectReq)(nil),            // 28: pb.AfterConnectReq
	(*AfterDisconnectReq)(nil),         // 29: pb.AfterDisconnectReq
	(*KeepAliveReq)(nil),               // 30: pb.KeepAliveReq
	(*KickUserConnReq)(nil),            // 31: pb.KickUserConnReq
	(*GetUserConnReq)(nil),             // 32: pb.GetUserConnReq
	(*SendMsgReq)(nil),                 // 33: pb.SendMsgReq
	(*KeepAliveResp)(nil),              // 34: pb.KeepAliveResp
	(*KickUserConnResp)(nil),           // 35: pb.KickUserConnResp
	(*GetUserConnResp)(nil),            // 36: pb.GetUserConnResp
	(*SendMsgResp)(nil),                // 37: pb.SendMsgResp
}
var file_im_proto_depIdxs = []int32{
	0,  // 0: pb.ImMQBody.event:type_name -> pb.ImMQBody.Event
	24, // 1: pb.BeforeConnectReq.connParam:type_name -> pb.ConnParam
	25, // 2: pb.GetUserLatestConnResp.ipRegion:type_name -> pb.IpRegion
	26, // 3: pb.BeforeRequestReq.commonReq:type_name -> pb.CommonReq
	27, // 4: pb.BeforeRequestResp.commonResp:type_name -> pb.CommonResp
	27, // 5: pb.BatchGetUserLatestConnResp.commonResp:type_name -> pb.CommonResp
	5,  // 6: pb.BatchGetUserLatestConnResp.userLatestConns:type_name -> pb.GetUserLatestConnResp
	26, // 7: pb.GetAllConvIdOfUserReq.commonReq:type_name -> pb.CommonReq
	27, // 8: pb.GetAllConvIdOfUserResp.commonResp:type_name -> pb.CommonResp
	26, // 9: pb.UpdateConvSettingReq.commonReq:type_name -> pb.CommonReq
	13, // 10: pb.UpdateConvSettingReq.convSetting:type_name -> pb.ConvSetting
	14, // 11: pb.UpdateConvSettingReq.convSetting2:type_name -> pb.ConvSettingProto2
	27, // 12: pb.UpdateConvSettingResp.commonResp:type_name -> pb.CommonResp
	26, // 13: pb.GetConvSettingReq.commonReq:type_name -> pb.CommonReq
	27, // 14: pb.GetConvSettingResp.commonResp:type_name -> pb.CommonResp
	13, // 15: pb.GetConvSettingResp.convSettings:type_name -> pb.ConvSetting
	14, // 16: pb.GetConvSettingResp.convSetting2s:type_name -> pb.ConvSettingProto2
	26, // 17: pb.TranslateTextReq.commonReq:type_name -> pb.CommonReq
	27, // 18: pb.TranslateTextResp.commonResp:type_name -> pb.CommonResp
	26, // 19: pb.BatchTranslateTextReq.commonReq:type_name -> pb.CommonReq
	27, // 20: pb.BatchTranslateTextResp.commonResp:type_name -> pb.CommonResp
	23, // 21: pb.BatchTranslateTextResp.results:type_name -> pb.BatchTranslateTextResp.ResultsEntry
	2,  // 22: pb.imService.BeforeConnect:input_type -> pb.BeforeConnectReq
	28, // 23: pb.imService.AfterConnect:input_type -> pb.AfterConnectReq
	29, // 24: pb.imService.AfterDisconnect:input_type -> pb.AfterDisconnectReq
	30, // 25: pb.imService.KeepAlive:input_type -> pb.KeepAliveReq
	31, // 26: pb.imService.KickUserConn:input_type -> pb.KickUserConnReq
	32, // 27: pb.imService.GetUserConn:input_type -> pb.GetUserConnReq
	6,  // 28: pb.imService.BeforeRequest:input_type -> pb.BeforeRequestReq
	4,  // 29: pb.imService.GetUserLatestConn:input_type -> pb.GetUserLatestConnReq
	8,  // 30: pb.imService.BatchGetUserLatestConn:input_type -> pb.BatchGetUserLatestConnReq
	33, // 31: pb.imService.SendMsg:input_type -> pb.SendMsgReq
	11, // 32: pb.imService.GetAllConvIdOfUser:input_type -> pb.GetAllConvIdOfUserReq
	15, // 33: pb.imService.UpdateConvSetting:input_type -> pb.UpdateConvSettingReq
	17, // 34: pb.imService.GetConvSetting:input_type -> pb.GetConvSettingReq
	19, // 35: pb.imService.TranslateText:input_type -> pb.TranslateTextReq
	21, // 36: pb.imService.BatchTranslateText:input_type -> pb.BatchTranslateTextReq
	3,  // 37: pb.imService.BeforeConnect:output_type -> pb.BeforeConnectResp
	27, // 38: pb.imService.AfterConnect:output_type -> pb.CommonResp
	27, // 39: pb.imService.AfterDisconnect:output_type -> pb.CommonResp
	34, // 40: pb.imService.KeepAlive:output_type -> pb.KeepAliveResp
	35, // 41: pb.imService.KickUserConn:output_type -> pb.KickUserConnResp
	36, // 42: pb.imService.GetUserConn:output_type -> pb.GetUserConnResp
	7,  // 43: pb.imService.BeforeRequest:output_type -> pb.BeforeRequestResp
	5,  // 44: pb.imService.GetUserLatestConn:output_type -> pb.GetUserLatestConnResp
	9,  // 45: pb.imService.BatchGetUserLatestConn:output_type -> pb.BatchGetUserLatestConnResp
	37, // 46: pb.imService.SendMsg:output_type -> pb.SendMsgResp
	12, // 47: pb.imService.GetAllConvIdOfUser:output_type -> pb.GetAllConvIdOfUserResp
	16, // 48: pb.imService.UpdateConvSetting:output_type -> pb.UpdateConvSettingResp
	18, // 49: pb.imService.GetConvSetting:output_type -> pb.GetConvSettingResp
	20, // 50: pb.imService.TranslateText:output_type -> pb.TranslateTextResp
	22, // 51: pb.imService.BatchTranslateText:output_type -> pb.BatchTranslateTextResp
...
func file_im_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_im_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConvSettingProto2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_im_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchTranslateTextReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_im_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BatchTranslateTextResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
