...
var file_im_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x81, 0x07, 0x0a, 0x09,
	...
	0x70, 0x12, 0x3c, 0x0a, 0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x54, 0x65,
	0x78, 0x74, 0x12, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74,
	0x65, 0x54, 0x65, 0x78, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x72,
	0x61, 0x6e, 0x73, 0x6c, 0x61, 0x74, 0x65, 0x54, 0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x70, 0x42,
...
var file_im_proto_goTypes = []interface{}{
	...
	(*ConnParam)(nil),                  // 20: pb.ConnParam
	(*IpRegion)(nil),                   // 21: pb.IpRegion
	(*CommonReq)(nil),                  // 22: pb.CommonReq
	(*CommonResp)(nil),                 // 23: pb.CommonResp
	(*AfterConnectReq)(nil),            // 24: pb.AfterConnectReq
	(*AfterDisconnectReq)(nil),         // 25: pb.AfterDisconnectReq
	(*KeepAliveReq)(nil),               // 26: pb.KeepAliveReq
	(*KickUserConnReq)(nil),            // 27: pb.KickUserConnReq
	(*GetUserConnReq)(nil),             // 28: pb.GetUserConnReq
	(*SendMsgReq)(nil),                 // 29: pb.SendMsgReq
	(*KeepAliveResp)(nil),              // 30: pb.KeepAliveResp
	(*KickUserConnResp)(nil),           // 31: pb.KickUserConnResp
	(*GetUserConnResp)(nil),            // 32: pb.GetUserConnResp
	(*SendMsgResp)(nil),                // 33: pb.SendMsgResp
}
var file_im_proto_depIdxs = []int32{
	0,  // 0: pb.ImMQBody.event:type_name -> pb.ImMQBody.Event
	20, // 1: pb.BeforeConnectReq.connParam:type_name -> pb.ConnParam
	21, // 2: pb.GetUserLatestConnResp.ipRegion:type_name -> pb.IpRegion
	22, // 3: pb.BeforeRequestReq.commonReq:type_name -> pb.CommonReq
	23, // 4: pb.BeforeRequestResp.commonResp:type_name -> pb.CommonResp
	23, // 5: pb.BatchGetUserLatestConnResp.commonResp:type_name -> pb.CommonResp
	5,  // 6: pb.BatchGetUserLatestConnResp.userLatestConns:type_name -> pb.GetUserLatestConnResp
	22, // 7: pb.GetAllConvIdOfUserReq.commonReq:type_name -> pb.CommonReq
	23, // 8: pb.GetAllConvIdOfUserResp.commonResp:type_name -> pb.CommonResp
	22, // 9: pb.UpdateConvSettingReq.commonReq:type_name -> pb.CommonReq
	13, // 10: pb.UpdateConvSettingReq.convSetting:type_name -> pb.ConvSetting
	23, // 11: pb.UpdateConvSettingResp.commonResp:type_name -> pb.CommonResp
	22, // 12: pb.GetConvSettingReq.commonReq:type_name -> pb.CommonReq
	23, // 13: pb.GetConvSettingResp.commonResp:type_name -> pb.CommonResp
	13, // 14: pb.GetConvSettingResp.convSettings:type_name -> pb.ConvSetting
	22, // 15: pb.TranslateTextReq.commonReq:type_name -> pb.CommonReq
	23, // 16: pb.TranslateTextResp.commonResp:type_name -> pb.CommonResp
	2,  // 17: pb.imService.BeforeConnect:input_type -> pb.BeforeConnectReq
	24, // 18: pb.imService.AfterConnect:input_type -> pb.AfterConnectReq
	25, // 19: pb.imService.AfterDisconnect:input_type -> pb.AfterDisconnectReq
	26, // 20: pb.imService.KeepAlive:input_type -> pb.KeepAliveReq
	27, // 21: pb.imService.KickUserConn:input_type -> pb.KickUserConnReq
	28, // 22: pb.imService.GetUserConn:input_type -> pb.GetUserConnReq
	6,  // 23: pb.imService.BeforeRequest:input_type -> pb.BeforeRequestReq
	4,  // 24: pb.imService.GetUserLatestConn:input_type -> pb.GetUserLatestConnReq
	8,  // 25: pb.imService.BatchGetUserLatestConn:input_type -> pb.BatchGetUserLatestConnReq
	29, // 26: pb.imService.SendMsg:input_type -> pb.SendMsgReq
	11, // 27: pb.imService.GetAllConvIdOfUser:input_type -> pb.GetAllConvIdOfUserReq
	14, // 28: pb.imService.UpdateConvSetting:input_type -> pb.UpdateConvSettingReq
	16, // 29: pb.imService.GetConvSetting:input_type -> pb.GetConvSettingReq
	18, // 30: pb.imService.TranslateText:input_type -> pb.TranslateTextReq
	3,  // 31: pb.imService.BeforeConnect:output_type -> pb.BeforeConnectResp
	23, // 32: pb.imService.AfterConnect:output_type -> pb.CommonResp
	23, // 33: pb.imService.AfterDisconnect:output_type -> pb.CommonResp
	30, // 34: pb.imService.KeepAlive:output_type -> pb.KeepAliveResp
	31, // 35: pb.imService.KickUserConn:output_type -> pb.KickUserConnResp
	32, // 36: pb.imService.GetUserConn:output_type -> pb.GetUserConnResp
	7,  // 37: pb.imService.BeforeRequest:output_type -> pb.BeforeRequestResp
	5,  // 38: pb.imService.GetUserLatestConn:output_type -> pb.GetUserLatestConnResp
	9,  // 39: pb.imService.BatchGetUserLatestConn:output_type -> pb.BatchGetUserLatestConnResp
	33, // 40: pb.imService.SendMsg:output_type -> pb.SendMsgResp
	12, // 41: pb.imService.GetAllConvIdOfUser:output_type -> pb.GetAllConvIdOfUserResp
	15, // 42: pb.imService.UpdateConvSetting:output_type -> pb.UpdateConvSettingResp
	17, // 43: pb.imService.GetConvSetting:output_type -> pb.GetConvSettingResp
	19, // 44: pb.imService.TranslateText:output_type -> pb.TranslateTextResp
