...
var file_im_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x64, 0x32, 0xf6, 0x02,
	...
	0x6e, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06,
...
var file_im_proto_goTypes = []interface{}{
	...
	(*KickUserConnResp)(nil),      // 13: pb.KickUserConnResp
	(*GetUserConnResp)(nil),       // 14: pb.GetUserConnResp
}
var file_im_proto_depIdxs = []int32{
	...
	3,  // 11: pb.imService.BeforeConnect:output_type -> pb.BeforeConnectResp
	12, // 12: pb.imService.AfterConnect:output_type -> pb.CommonResp
	12, // 13: pb.imService.AfterDisconnect:output_type -> pb.CommonResp
	13, // 14: pb.imService.KickUserConn:output_type -> pb.KickUserConnResp
	14, // 15: pb.imService.GetUserConn:output_type -> pb.GetUserConnResp
	7,  // 16: pb.imService.GetUserLatestConn:output_type -> pb.GetUserLatestConnResp
