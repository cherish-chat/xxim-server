...
var file_im_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x6e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x49, 0x64, 0x73, 0x32, 0x86, 0x05,
...
var file_im_proto_goTypes = []interface{}{
	...
	(*KickUserConnReq)(nil),            // 19: pb.KickUserConnReq
	(*GetUserConnReq)(nil),             // 20: pb.GetUserConnReq
	(*SendMsgReq)(nil),                 // 21: pb.SendMsgReq
	(*KickUserConnResp)(nil),           // 22: pb.KickUserConnResp
	(*GetUserConnResp)(nil),            // 23: pb.GetUserConnResp
	(*SendMsgResp)(nil),                // 24: pb.SendMsgResp
}
var file_im_proto_depIdxs = []int32{
	...
	19, // 12: pb.imService.KickUserConn:input_type -> pb.KickUserConnReq
	20, // 13: pb.imService.GetUserConn:input_type -> pb.GetUserConnReq
	6,  // 14: pb.imService.BeforeRequest:input_type -> pb.BeforeRequestReq
	4,  // 15: pb.imService.GetUserLatestConn:input_type -> pb.GetUserLatestConnReq
	8,  // 16: pb.imService.BatchGetUserLatestConn:input_type -> pb.BatchGetUserLatestConnReq
	21, // 17: pb.imService.SendMsg:input_type -> pb.SendMsgReq
	11, // 18: pb.imService.GetAllConvIdOfUser:input_type -> pb.GetAllConvIdOfUserReq
	3,  // 19: pb.imService.BeforeConnect:output_type -> pb.BeforeConnectResp
	16, // 20: pb.imService.AfterConnect:output_type -> pb.CommonResp
	16, // 21: pb.imService.AfterDisconnect:output_type -> pb.CommonResp
	22, // 22: pb.imService.KickUserConn:output_type -> pb.KickUserConnResp
	23, // 23: pb.imService.GetUserConn:output_type -> pb.GetUserConnResp
	7,  // 24: pb.imService.BeforeRequest:output_type -> pb.BeforeRequestResp
	5,  // 25: pb.imService.GetUserLatestConn:output_type -> pb.GetUserLatestConnResp
	9,  // 26: pb.imService.BatchGetUserLatestConn:output_type -> pb.BatchGetUserLatestConnResp
	24, // 27: pb.imService.SendMsg:output_type -> pb.SendMsgResp
	12, // 28: pb.imService.GetAllConvIdOfUser:output_type -> pb.GetAllConvIdOfUserResp
