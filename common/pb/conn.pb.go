...
const (
	...
	// 响应返回
	PushEvent_ReturnResponse PushEvent = 2
)
...
const (
	// 发送消息
	RequestEvent_SendMsgList RequestEvent = 0
	// 批量获取会话的消息seq
	RequestEvent_SyncConvSeq RequestEvent = 1
	// 批量同步消息列表
	RequestEvent_SyncMsgList RequestEvent = 2
	// 确认消费通知
	RequestEvent_AckNotice RequestEvent = 3
	// 获取一条消息
	RequestEvent_GetMsgById RequestEvent = 4
)

// Enum value maps for RequestEvent.
var (
	RequestEvent_name = map[int32]string{
		0: "SendMsgList",
		1: "SyncConvSeq",
		2: "SyncMsgList",
		3: "AckNotice",
	...
	RequestEvent_value = map[string]int32{
		"SendMsgList": 0,
		"SyncConvSeq": 1,
		"SyncMsgList": 2,
		"AckNotice":   3,
...
func (x RequestEvent) Enum() *RequestEvent {
	p := new(RequestEvent)
	*p = x
	return p
}
...
func (RequestEvent) Descriptor() protoreflect.EnumDescriptor {
	return file_conn_proto_enumTypes[1].Descriptor()
}

func (RequestEvent) Type() protoreflect.EnumType {
	return &file_conn_proto_enumTypes[1]
}

func (x RequestEvent) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RequestEvent.Descriptor instead.
...
type RequestBody struct {
	...
	Event RequestEvent `protobuf:"varint,1,opt,name=event,proto3,enum=pb.RequestEvent" json:"event"`
...
func (x *RequestBody) GetEvent() RequestEvent {
	if x != nil {
		return x.Event
	}
	return RequestEvent_SendMsgList
}
...
func (x *ResponseBody) GetEvent() RequestEvent {
	if x != nil {
		return x.Event
	}
	return RequestEvent_SendMsgList
...
var file_conn_proto_rawDesc = []byte{
	...
	0x22, 0x5f, 0x0a, 0x0b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x6f, 0x64, 0x79, 0x12,
	0x26, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10,
	0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x65, 0x71, 0x49, 0x64,
	...
	0x61, 0x22, 0x74, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x6f, 0x64,
	0x79, 0x12, 0x26, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x45, 0x76, 0x65,
	...
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x81, 0x01, 0x0a, 0x0a, 0x53, 0x65, 0x6e, 0x64,
	...
	,
...
var file_conn_proto_goTypes = []interface{}{
	...
	(RequestEvent)(0),          // 1: pb.RequestEvent
	...
	(*SendMsgResp)(nil),        // 13: pb.SendMsgResp
	(*AfterConnectReq)(nil),    // 14: pb.AfterConnectReq
	(*AfterDisconnectReq)(nil), // 15: pb.AfterDisconnectReq
	nil,                        // 16: pb.ConnParam.HeadersEntry
	(*CommonResp)(nil),         // 17: pb.CommonResp
}
var file_conn_proto_depIdxs = []int32{
	2,  // 0: pb.ConnMQBody.event:type_name -> pb.ConnMQBody.Event
	16, // 1: pb.ConnParam.headers:type_name -> pb.ConnParam.HeadersEntry
	17, // 2: pb.GetUserConnResp.commonResp:type_name -> pb.CommonResp
	...
	17, // 5: pb.KickUserConnResp.commonResp:type_name -> pb.CommonResp
	0,  // 6: pb.PushBody.event:type_name -> pb.PushEvent
	1,  // 7: pb.RequestBody.event:type_name -> pb.RequestEvent
	1,  // 8: pb.ResponseBody.event:type_name -> pb.RequestEvent
	5,  // 9: pb.SendMsgReq.getUserConnReq:type_name -> pb.GetUserConnReq
	0,  // 10: pb.SendMsgReq.event:type_name -> pb.PushEvent
	17, // 11: pb.SendMsgResp.commonResp:type_name -> pb.CommonResp
	4,  // 12: pb.SendMsgResp.successConnParams:type_name -> pb.ConnParam
	4,  // 13: pb.SendMsgResp.failedConnParams:type_name -> pb.ConnParam
	4,  // 14: pb.AfterConnectReq.connParam:type_name -> pb.ConnParam
	4,  // 15: pb.AfterDisconnectReq.connParam:type_name -> pb.ConnParam
	7,  // 16: pb.connService.KickUserConn:input_type -> pb.KickUserConnReq
	5,  // 17: pb.connService.GetUserConn:input_type -> pb.GetUserConnReq
	12, // 18: pb.connService.SendMsg:input_type -> pb.SendMsgReq
	8,  // 19: pb.connService.KickUserConn:output_type -> pb.KickUserConnResp
	6,  // 20: pb.connService.GetUserConn:output_type -> pb.GetUserConnResp
	13, // 21: pb.connService.SendMsg:output_type -> pb.SendMsgResp
