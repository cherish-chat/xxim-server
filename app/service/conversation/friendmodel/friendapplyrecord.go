...
type FriendApplyStatus = peerpb.FriendApplyStatus

const (
	FriendApplyStatusApplying = peerpb.FriendApplyStatus_FriendApplying
	FriendApplyStatusAccepted = peerpb.FriendApplyStatus_FriendAccepted
	FriendApplyStatusRejected = peerpb.FriendApplyStatus_FriendRejected
)
