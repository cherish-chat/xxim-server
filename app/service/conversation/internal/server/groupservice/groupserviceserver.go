...
func (s *GroupServiceServer) ListMyJoinedGroup(ctx context.Context, in *peerpb.ListMyJoinedGroupReq) (*peerpb.ListMyJoinedGroupResp, error) {
	l := groupservicelogic.NewListMyJoinedGroupLogic(ctx, s.svcCtx)
	return l.ListMyJoinedGroup(in)
}
