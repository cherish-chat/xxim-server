...
func (m *defaultChannelService) ChannelAfterKeepAlive(ctx context.Context, in *ChannelAfterKeepAliveReq, opts ...grpc.CallOption) (*ChannelAfterKeepAliveResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.ChannelAfterKeepAlive(ctx, in, opts...)
}

func (m *defaultChannelService) ChannelAfterOnline(ctx context.Context, in *ChannelAfterOnlineReq, opts ...grpc.CallOption) (*ChannelAfterOnlineResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.ChannelAfterOnline(ctx, in, opts...)
}

func (m *defaultChannelService) ChannelAfterOffline(ctx context.Context, in *ChannelAfterOfflineReq, opts ...grpc.CallOption) (*ChannelAfterOfflineResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.ChannelAfterOffline(ctx, in, opts...)
}

func (m *defaultChannelService) UpsertChannelMember(ctx context.Context, in *UpsertChannelMemberReq, opts ...grpc.CallOption) (*UpsertChannelMemberResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.UpsertChannelMember(ctx, in, opts...)
}

func (m *defaultChannelService) DeleteChannelMember(ctx context.Context, in *DeleteChannelMemberReq, opts ...grpc.CallOption) (*DeleteChannelMemberResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.DeleteChannelMember(ctx, in, opts...)
}

func (m *defaultChannelService) ListChannelSubscribers(ctx context.Context, in *ListChannelSubscribersReq, opts ...grpc.CallOption) (*ListChannelSubscribersResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.ListChannelSubscribers(ctx, in, opts...)
}

func (m *defaultChannelService) ListMyChannels(ctx context.Context, in *ListMyChannelsReq, opts ...grpc.CallOption) (*ListMyChannelsResp, error) {
	client := peerpb.NewChannelServiceClient(m.cli.Conn())
	return client.ListMyChannels(ctx, in, opts...)
}
