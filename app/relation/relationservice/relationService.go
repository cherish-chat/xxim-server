...
type (
	...
	MapUserRemarkReq          = pb.MapUserRemarkReq
	MapUserRemarkResp         = pb.MapUserRemarkResp
	...
	UpdateUserRemarkReq       = pb.UpdateUserRemarkReq
	UpdateUserRemarkResp      = pb.UpdateUserRemarkResp
...
func (m *defaultRelationService) MapUserRemark(ctx context.Context, in *MapUserRemarkReq, opts ...grpc.CallOption) (*MapUserRemarkResp, error) {
	client := pb.NewRelationServiceClient(m.cli.Conn())
	return client.MapUserRemark(ctx, in, opts...)
}

func (m *defaultRelationService) UpdateUserRemark(ctx context.Context, in *UpdateUserRemarkReq, opts ...grpc.CallOption) (*UpdateUserRemarkResp, error) {
	client := pb.NewRelationServiceClient(m.cli.Conn())
	return client.UpdateUserRemark(ctx, in, opts...)
}
