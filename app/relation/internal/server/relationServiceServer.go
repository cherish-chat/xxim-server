...
func (s *RelationServiceServer) MapUserRemark(ctx context.Context, in *pb.MapUserRemarkReq) (*pb.MapUserRemarkResp, error) {
	l := logic.NewMapUserRemarkLogic(ctx, s.svcCtx)
	return l.MapUserRemark(in)
}

func (s *RelationServiceServer) UpdateUserRemark(ctx context.Context, in *pb.UpdateUserRemarkReq) (*pb.UpdateUserRemarkResp, error) {
	l := logic.NewUpdateUserRemarkLogic(ctx, s.svcCtx)
	return l.UpdateUserRemark(in)
}
