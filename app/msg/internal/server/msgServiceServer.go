...
// SendRedPacket 发红包
func (s *MsgServiceServer) SendRedPacket(ctx context.Context, in *pb.SendRedPacketReq) (*pb.SendRedPacketResp, error) {
	l := logic.NewSendRedPacketLogic(ctx, s.svcCtx)
	return l.SendRedPacket(in)
}

// ReceiveRedPacket 领取红包
func (s *MsgServiceServer) ReceiveRedPacket(ctx context.Context, in *pb.ReceiveRedPacketReq) (*pb.ReceiveRedPacketResp, error) {
	l := logic.NewReceiveRedPacketLogic(ctx, s.svcCtx)
	return l.ReceiveRedPacket(in)
}

// GetRedPacketDetail 获取红包详情
func (s *MsgServiceServer) GetRedPacketDetail(ctx context.Context, in *pb.GetRedPacketDetailReq) (*pb.GetRedPacketDetailResp, error) {
	l := logic.NewGetRedPacketDetailLogic(ctx, s.svcCtx)
	return l.GetRedPacketDetail(in)
}
