	...
	menus := genMenu([]*pb.MSMenu{
		...
		//INSERT INTO `la_system_auth_menu` VALUES (100, 0, 'M', '权限管理', 'el-icon-Lock', 44, '', 'permission', '', '', '', 0, 1, 0, 1650341765, 1662626201);
		{
			...
			Children: []*pb.MSMenu{
				...
				//INSERT INTO `la_system_auth_menu` VALUES (160, 100, 'C', '登录日志', 'el-icon-CameraFilled', 0, 'system:loginlog:list', 'loginlog', 'permission/loginlog/index', '', '', 1, 1, 0, 1650341765, 1650341765);
				{
					Id:           "160",
					UpdatedAtStr: time.Now().Format("2006-01-02 15:04:05"),
					UpdatedBy:    "system",
					...
					MenuType:     "C",
					MenuName:     "登录日志",
					MenuIcon:     "el-icon-CameraFilled",
					MenuSort:     0,
					Perms:        "system:loginlog:list",
					Paths:        "loginlog",
					Component:    "permission/loginlog/index",
					Selected:     "",
					Params:       "",
					IsCache:      true,
					IsShow:       true,
		...
		//INSERT INTO `la_system_auth_menu` VALUES (300, 0, 'M', 'app管理', 'el-icon-Apple', 48, '', 'app', '', '', '', 0, 1, 0, 1650341765, 1650341765);
		{
			Id:           "300",
			UpdatedAtStr: time.Now().Format("2006-01-02 15:04:05"),
			UpdatedBy:    "system",
			...
			IsDisable:    false,
			Children: []*pb.MSMenu{
				//INSERT INTO `la_system_auth_menu` VALUES (301, 300, 'C', '基础配置', 'el-icon-Setting', 0, '', 'app/config', 'app/config/index', '', '', 1, 1, 0, 1650341765, 1650341765);
				{
					Id:           "301",
					UpdatedAtStr: time.Now().Format("2006-01-02 15:04:05"),
					UpdatedBy:    "system",
					...
					IsDisable:    false,
					Children: []*pb.MSMenu{
						//INSERT INTO `la_system_auth_menu` VALUES (302, 301, 'A', '更新配置', '', 0, 'app:config:edit', '', '', '', '', 0, 1, 0, 1650341765, 1650341765);
						{
							Id:           "302",
							UpdatedAtStr: time.Now().Format("2006-01-02 15:04:05"),
							UpdatedBy:    "system",
