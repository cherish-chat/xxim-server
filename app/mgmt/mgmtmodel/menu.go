...
func initMenu(tx *gorm.DB) {
	menus := genMenu([]*pb.MSMenu{
		...
		genMenu1("100", "权限管理", "el-icon-Lock", 44, "permission",
			...
			genMenu2("180", "100", "lua脚本", "local-icon-zuliaoyuding", 0,
				"system:luaconfig:list", "luaconfig", "permission/luaconfig/index",
				genMenu3("181", "180", "脚本详情", "system:luaconfig:detail"),
				genMenu3("182", "180", "脚本新增", "system:luaconfig:add"),
				genMenu3("183", "180", "脚本编辑", "system:luaconfig:edit"),
				genMenu3("184", "180", "脚本删除", "system:luaconfig:del"),
			),
		),
...
var IconElement2Map = map[string]string{
	"el-icon-Monitor":         "archive-line",
	"el-icon-Lock":            "lock-line",
	"el-icon-link":            "link-m",
	"el-icon-tickets":         "article-line",
	"local-icon-wode":         "alarm-warning-line",
	"el-icon-Female":          "account-box-line",
	"el-icon-Operation":       "app-store-line",
	"el-icon-Key":             "folder-keyhole-line",
	"el-icon-List":            "file-list-2-line",
	"el-icon-Notebook":        "file-list-2-line",
	"el-icon-CameraFilled":    "list-check",
	"local-icon-KMSguanli":    "apps-line",
	"el-icon-Setting":         "archive-drawer-fill",
	"el-icon-Connection":      "archive-fill",
	"el-icon-Apple":           "archive-line",
	"el-icon-UserFilled":      "ancient-gate-fill",
	"el-icon-ChatLineRound":   "align-left",
	"el-icon-ElementPlus":     "article-line",
	"el-icon-LocationFilled":  "at-fill",
	"el-icon-Location":        "artboard-line",
	"local-icon-xiangji":      "blaze-fill",
